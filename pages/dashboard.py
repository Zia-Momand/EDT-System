        ...
        with st.container():
            ...
            components.html(f"""
                ...
                <script type="module">
                    ...
                    const textures = [];
                    for (let i = 1; i <= 8; i++) {{
                        textures.push(textureLoader.load(`https://eldersynchealth.com/static/models/textures/000${{i}}.png`));
                    }}
                    ...
                    loader.load(
                        "https://eldersynchealth.com/static/models/anim/beating-heart-v007a-animated.gltf",
                        (gltf) => {{
